  ...
  return (
    ...
    <div className='app__footer-cards'>
        <div className="app__footer-card">
            ...
            <a href="mailto: singh9765h@gmail.com" className='p-text'>Hello hrmn@mail.com</a>
        </div>
        <div className="app__footer-card">
            <img src={images.mobile} alt="mobile" />
            <a href="tel: +91-9478849065" className='p-text'>Call me</a>
        </div>
    </div>
...
export default AppWrap( 
    MotionWrap(Footer, 'app__footer') , 'footer', "app__whitebg")